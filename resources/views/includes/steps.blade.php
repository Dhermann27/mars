...
@if(Gate::allows('has-paid') || (session()->has('camper') && Gate::allows('is-council')))
    <ul id="littlesteps" class="nav nav-pills nav-fill mb-4">
        ...
        <li class="nav-item mx-5">
            <i id="camper-success" class="far fa-check btn-success float-end d-none"></i>
        ...
        <li class="nav-item mx-5">
            <i id="payment-success" class="far fa-check btn-success float-end d-none"></i>
        ...
        @if($year->is_live)
            <li class="nav-item mx-5">
                <i id="workshop-success" class="far fa-check btn-success float-end d-none"></i>
            ...
            <li class="nav-item mx-5">
                <i id="room-success" class="far fa-check btn-success float-end d-none"></i>
