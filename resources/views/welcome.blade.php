                ...
                <div class="row mt-2">
                    ...
                    <div class="col-lg-6 d-sm-flex align-content-center d-flex align-items-center">
                        <div class="mr-auto py-0 pl-lg-5 my-3 my-md-0">
                            ...
                            @if($year->is_brochure)
                                <p>The Unitarian Universalist Church of Bloomington welcomes all MUUSAns to Bloomington
                                    July 3-7. The APC is still working on the programming, but we have made arrangements
                                    for very affordable housing and meals through the Indiana University dorms — and the
                                    dorm we will be in is 0.6 miles from the church! There will also be hotel options in
                                    many price ranges in addition to the dorms.</p>
                                <p>Meyer (junior high), Burt (high school), and Young Adults (YA) will have dedicated
                            ...
                            @else
                                ...
                                @endcan
                                our Planning Council is working diligently to prepare this year's information, which
                                should
